...
void _categoryModelSerialize(
  ...
  writer.writeLong(offsets[1], object.lastSequence);
...
CategoryModel _categoryModelDeserialize(
  ...
  final object = CategoryModel(
    ...
    id: id,
    lastSequence: reader.readLongOrNull(offsets[1]) ?? 0,
...
extension CategoryModelByIndex on IsarCollection<CategoryModel> {
  ...
  Future<CategoryModel?> getByCode(String code) {
    return getByIndex(r'code', [code]);
  }

  CategoryModel? getByCodeSync(String code) {
  ...
  Future<List<CategoryModel?>> getAllByCode(List<String> codeValues) {
    final values = codeValues.map((e) => [e]).toList();
    return getAllByIndex(r'code', values);
  }

  List<CategoryModel?> getAllByCodeSync(List<String> codeValues) {
    final values = codeValues.map((e) => [e]).toList();
  ...
  Future<Id> putByCode(CategoryModel object) {
    return putByIndex(r'code', object);
  }

  Id putByCodeSync(CategoryModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'code', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByCode(List<CategoryModel> objects) {
    return putAllByIndex(r'code', objects);
  }

  List<Id> putAllByCodeSync(List<CategoryModel> objects,
      {bool saveLinks = true}) {
...
extension CategoryModelQueryWhere
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterWhereClause> codeEqualTo(
      String code) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'code',
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterWhereClause> codeNotEqualTo(
      String code) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension CategoryModelQueryFilter
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition> codeEqualTo(
    String value, {
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition> codeBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition> codeMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition>
      lastSequenceEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'lastSequence',
        value: value,
      ));
    });
  }
...
extension CategoryModelQuerySortBy
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> sortByCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'code', Sort.asc);
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> sortByCodeDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy>
      sortByLastSequence() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastSequence', Sort.asc);
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy>
      sortByLastSequenceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastSequence', Sort.desc);
    });
  }
...
extension CategoryModelQuerySortThenBy
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> thenByCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'code', Sort.asc);
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> thenByCodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'code', Sort.desc);
    });
  }
...
extension CategoryModelQueryWhereDistinct
  ...
  QueryBuilder<CategoryModel, CategoryModel, QDistinct> distinctByCode(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryModel, CategoryModel, QDistinct>
      distinctByLastSequence() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'lastSequence');
    });
  }
...
extension CategoryModelQueryProperty
  ...
  QueryBuilder<CategoryModel, String, QQueryOperations> codeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'code');
    });
  }

  QueryBuilder<CategoryModel, int, QQueryOperations> lastSequenceProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'lastSequence');
    });
  }
